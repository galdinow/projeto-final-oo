            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="cadastro.html">Criar Conta</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Trabalho OO bla bla bla divo</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis sed, architecto sapiente perferendis blanditiis asperiores aliquid delectus quasi pariatur voluptate laborum esse eius ullam dicta perspiciatis debitis dolores iure quibusdam.</p>
                        <a class="btn btn-primary btn-xl" href="cadastro.html">Cadastre-se!</a>
                    </div>
                </div>
            </div>
        </header>
